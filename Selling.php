...
<!-- Heart Container -->
 ...
 <div class="row">
    <div class="col">
        ...
        <input class="form-control" id="date" name="Expiration_date" placeholder="YYYY-MM-DD    > Bill date" type="text"/>
       

    </div>
    </div>
    <div class="col">
      <input type="text" class="form-control" id="Bill_Txrf_Number" placeholder="Bill_Txrf_Number">
    </div>
  </div>
...
foreach ($R_Category as $row_Category) {
  ...
  echo '<option value="'.$row_Category['CS_ID'].'">'.$row_Category['CS_Name'].'</option>';
}
...
<form action="./Selling_Handler.php" method="POST">
