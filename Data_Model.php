<?php
 ...
 $statement = $Connect->prepare('SELECT  Product_Data.Product_ID , Product_Data.NameEN , Product_Data.NameAR , Product_Data.Add_Date ,Product_Data.Add_Time , Product_Data.Unit_Price , Product_Data.Avilable , Product_Data.Manifacuring_Date ,Product_Data.Expiration_Date ,  Product_Data.Image_Url_B , Product_Data.Image_Url_S ,Product_Data.Product_Describtion , Product_Data.Product_Note ,Category_Data.Cat_Name , Brand_Data.Brand_Name FROM Product_Data JOIN Brand_Data ON Brand_Data.Brand_ID=Product_Data.Brand_ID JOIN Exer_Client ON Product_Data.Product_ID=Exer_Client.Product_ID JOIN Category_Data ON Category_Data.Cat_ID=Exer_Client.Cat_ID WHERE  Product_Data.Product_ID = '.$IDX.' ');
            $statement->execute();
